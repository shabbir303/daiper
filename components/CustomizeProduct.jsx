    ...
    return (
        <div className='flex flex-col gap-6'>
            ...
            <ul className='flex items-center gap-3'>
                <li className='ring-1 ring-red-600 text-red-600 rounded-xl py-1 px-4 text-sm cursor-pointer'>Small</li>
                <li className='ring-1 ring-red-600 text-white bg-red-600 rounded-xl py-1 px-4 text-sm cursor-pointer'>Medium</li>
                <li className='ring-1 ring-pink-200 text-white bg-pink-200 rounded-xl py-1 px-4 text-sm cursor-not-allowed'>Large</li>
            </ul>
        </div>
    );
};
