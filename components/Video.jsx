...
const Video = () => {
    ...
    return (
        <div className=' bg-[#B52555] relative pb-[30px] mb-[30px]'>
            <h1 className='text-center text-[25px] md:text-[49px] pt-[20px] font-bold text-white'>কিনুন একবার-<span className='text-[#FFFF00]'>ব্যবহার করুন বারবার!</span></h1>
             {/* Video Container */}
             <div className="relative mt-5 mx-auto md:w-[890px] h-[300px] md:h-[500px]  md:rounded-2xl">
