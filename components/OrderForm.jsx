...
const OrderForm = () => {
  return (
    <>
      <div>
      <h1 className='text-center text-[30px] font-bold bg-[#B52555] md:w-[1200px] mx-auto my-[100px] text-white rounded-xl'>অর্ডার করতে নিচের ফর্মে আপনার নাম, পূর্ণ ঠিকানা এবং মোবাইল নাম্বার লিখুন।</h1>
      </div>
      ...
      <div className="w-full md:w-1/2 mt-8 md:mt-0">
        ...
        {/* Confirm Button */}
        <button className="w-full mt-4 py-3 bg-[#B52555] text-white rounded font-bold hover:bg-purple-700">
